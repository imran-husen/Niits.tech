...
<head>
   ...
   <link rel="icon" href="{{ asset('/image/main_logo.png') }}" type="image/png"> 
    ...
    <title>Cultural Event Participation Reciept</title>
...
<div class="container">
    <h2 class="text-center mb-4 fw-bold text-danger">Cultural Event Participation Recieptt</h2>

    <div class="card p-4">
        <form id="studentForm"  action="CulturalEvent" method="post" onsubmit="return confirmSubmit()">
        @csrf
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control" id="event" name="event_name" onchange="updatePrice()">
                        ...
                        <option value="Fashion Show" data-price="400">Fashion Show</option>
                        <option value="The Dancing Fever" data-price="100">The Dancing Fever</option>
                        <option value="The Singing Sensation" data-price="100">The Singing Sensation</option>
                        <option value="Mehandi" data-price="50">Mehandi</option>
                        <option value="Rangoli" data-price="50">Rangoli</option>
                        <option value="poster Making" data-price="50">poster Making</option>
                        <option value="Card Making" data-price="50">Card Making</option>
                        <option value="Talent Hunt" data-price="50">Talent Hunt</option>
